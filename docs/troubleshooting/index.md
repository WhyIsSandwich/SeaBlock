...
This section collects recurring failure modes from community support threads and maps them to reproducible checks.
...
1. Confirm game version and SeaBlock pack version.
2. Confirm mod list and startup setting assumptions.
